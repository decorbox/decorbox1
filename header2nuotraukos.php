...
<div class='row '>
		...
		<form method='GET' >
			<button class='langButton' name='lang' value='LT'><img src='images/decorbox/lt.gif'</button> 
			<button class='langButton' name='lang' value='EN'><img src='images/decorbox/us.jpeg'</button>
		</form>
		</div>
	</div>";
$display_block1.="
<div class='row border-color header-edit'>
	<div class='col-md-4 pull-left'>
		<img class='img-responsive' width='350px' src='images/decorbox/logo.png'>
	</div>
	...
	<div class='col-md-8 test '>
		<div class='slider1 '>";
			...
			while($photo = mysqli_fetch_array($slide_photo_res)){
				...
				$display_block1.="<div class='slide' ><img width='350px' height='240px' ATL='$title' title='$title' src='$img'></div>";
			}
