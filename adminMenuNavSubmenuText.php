...
$display_block.= "<h1 class='text-center'>Kursų aprašymai</h1>";
	 						$display_block.="<div class='row'> <div class='col-md-2 col-md-offset-10'>				
	 							<button type='button' name='buttonAddItem' class='btn btn-primary' data-toggle='modal' data-target='#addItem'><span class='glyphicon glyphicon-plus' aria-hidden='true'></span> Įdėti kursą</button>
	 						</div></div>";
