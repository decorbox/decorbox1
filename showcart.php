...
//duombazej itemo kaina blogai rodo/ kai updeitini
...
//reikia padaryt kad kai istrina is shoppertrack istrintu ir is sotre_orders
...
if (isset($store_orders['sel_item_qty']) && $store_orders['sel_item_qty'] > 0) {
            // update cart product
            $update_store_orders_sql = "UPDATE store_orders_items
           	    SET sel_item_qty = '".$store_orders['sel_item_qty']."' + '" . $item_qty . "', sel_item_price = '".$store_orders['sel_item_price']."' + '".$total_price."'
                WHERE sel_item_id = '" . (int)$sel_item_id . "'";
